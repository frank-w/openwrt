...
define Build/banapi_bpi-r4-sdcard-common
  mt798x-gpt sdmmc |\
        ...
        $(if $(CONFIG_TARGET_ROOTFS_INITRAMFS),\
           ...
           pad-to 44M | mt7988-bl2 spim-nand-ubi-comb$(1) |\
           pad-to 45M | mt7988-bl31-uboot $$(DEVICE_NAME)-snand |\
           pad-to 51M | mt7988-bl2 emmc-comb$(1) |\
...
define Device/bananapi_bpi-r4-common
  ...
  ARTIFACT/sdcard.img.gz  := $(call Build/banapi_bpi-r4-sdcard-common)
  ARTIFACT/sdcard-8g.img.gz := $(call Build/banapi_bpi-r4-sdcard-common,-4bg)
  IMAGE_SIZE := $$(shell expr 64 + $$(CONFIG_TARGET_ROOTFS_PARTSIZE))m
  KERNEL			:= kernel-bin | gzip
  KERNEL_INITRAMFS := kernel-bin | lzma | \
	fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb with-initrd | pad-to 64k
